...
func EncodeUserRequest(_ context.Context, request *http.Request, r interface{}) error {
	user_request := r.(UserRequest)
	request.URL.Path += "/user/" + strconv.Itoa(user_request.Uid)
	return nil
}

func DecodeUserResponse(_ context.Context, res *http.Response) (response interface{}, err error) {
